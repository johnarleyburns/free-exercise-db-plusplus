...
public struct ExerciseObservation: Codable, Sendable, Equatable { public let exerciseId: String?; public let exerciseName: String?; public let exercisePrescriptionId: String?; public let order: Int?; public let laterality: String?; public let substitution: JSONValue?; public let sets: [SetObservation]; public init(exerciseId: String?, exerciseName: String? = nil, order: Int, laterality: String? = nil, sets: [SetObservation], exercisePrescriptionId: String? = nil, substitution: JSONValue? = nil) { self.exerciseId = exerciseId; self.exerciseName = exerciseName; self.exercisePrescriptionId = exercisePrescriptionId; self.order = order; self.laterality = laterality; self.substitution = substitution; self.sets = sets } }
