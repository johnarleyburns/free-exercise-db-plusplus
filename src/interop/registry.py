            ...
            for e in d.get("entries",[]):
                if d["mappingKind"] == "category":
                    ...
                    for x in (e.get("dbppExerciseIds") or [None]):
                        out.append(MappingMatch(d["target"],e["externalId"],x,e["externalName"],e["relation"],e["direction"],e["confidence"],{**e["provenance"], "mappingVersion":d.get("mappingVersion")},d["mappingKind"]))
        return cls(out)
